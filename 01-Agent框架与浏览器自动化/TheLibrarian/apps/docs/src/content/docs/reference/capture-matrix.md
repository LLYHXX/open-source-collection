...
<!-- GENERATED by scripts/docs-gen.mjs from docs/harness-capture-capability.md. Do not edit by hand — run `pnpm docs:gen` to update. -->

_Reproduced from `docs/harness-capture-capability.md` (the canonical source) — edit that file, not this page._
...
criteria and lives in git history; see ADR 0009
for the decision and the Claude integration README
